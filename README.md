...
🔧 Projects
- `dev` [`🚧 spencer-sliffe/lead-lint-pro 🚧`](https://github.com/spencer-sliffe/lead-lint-pro)
- `dev` [`🚧 spencer-sliffe/skogadesigns 🚧`](https://github.com/spencer-sliffe/skogadesigns)
...
🧑‍💻 Work
- `Software Architect` `Cornerstone Integration` `Nov 2025 - present`
